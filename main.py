...
# graphs
graphs.bar_graph(df_sub, year, 'Population in the largest city (% of urban population)', 'Country Name', '')
graphs.bar_graph(df_sub, year, 'Access to electricity, urban (% of urban population)', 'Country Name', '')
graphs.heatmap(df_sub, 'Romania', indicators_array,'crest')
graphs.heatmap(df_sub, 'United States', indicators_array,'BuPu')
